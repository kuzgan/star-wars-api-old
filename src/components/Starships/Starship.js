    ...
    <div>
      {loading ? (
        ...
        <div>
          ...
          <span>Hyperdrive rating: {capitalize(data?.hyperdrive_rating)}</span>
          <span>MGLT: {capitalize(data?.MGLT)}</span>
          <span>Starship class: {capitalize(data?.starship_class)}</span>
        </div>
      )}
